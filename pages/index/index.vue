<template>
	<view class="clock" :class="[bglight? 'light': 'dark']" @click="screenClick">
					...
					<view :class="[!h2.active? 'active':'before']">
						<view>
							<view class="up">
								...
								<view class="inn">{{!h2.active? h2.n && h2.n.active:h2.n && h2.n.before}}</view>
							</view>
							<view class="down">
								<view class="shadow"></view>
								<view class="inn">{{!h2.active? h2.n && h2.n.active:h2.n && h2.n.before}}</view>
				...
				<view class="flip hourplay">
					<view :class="[!h.active? 'active':'before']">
						<view>
							<view class="up">
								<view class="shadow"></view>
								<view class="inn">{{!h.active? h.n && h.n.active:h.n && h.n.before}}</view>
							</view>
							<view class="down">
								<view class="shadow"></view>
								<view class="inn">{{!h.active? h.n && h.n.active:h.n && h.n.before}}</view>
				...
				<view class="flip minuteplay2">
					<view :class="[!m2.active? 'active':'before']">
						<view>
							<view class="up">
								<view class="shadow"></view>
								<view class="inn">{{!m2.active? m2.n && m2.n.active:m2.n && m2.n.before}}</view>
							</view>
							<view class="down">
								<view class="shadow"></view>
								<view class="inn">{{!m2.active? m2.n && m2.n.active:m2.n && m2.n.before}}</view>
				...
				<view class="flip minuteplay">
					<view :class="[!m.active? 'active': 'before']">
						<view>
							<view class="up">
								<view class="shadow"></view>
								<view class="inn">{{!m.active? m.n && m.n.active:m.n && m.n.before}}</view>
							</view>
							<view class="down">
								<view class="shadow"></view>
								<view class="inn">{{!m.active? m.n && m.n.active:m.n && m.n.before}}</view>
				...
				<view class="flip secondplay2">
					<view :class="[!s2.active? 'active': 'before']">
						<view>
							<view class="up">
								<view class="shadow"></view>
								<view class="inn">{{!s2.active? s2.n && s2.n.active:s2.n && s2.n.before}}</view>
							</view>
							<view class="down">
								<view class="shadow"></view>
								<view class="inn">{{!s2.active? s2.n && s2.n.active:s2.n && s2.n.before}}</view>
				...
				<view class="flip secondplay">
					<view :class="[!s.active? 'active': 'before']">
						<view>
							<view class="up">
								<view class="shadow"></view>
								<view class="inn">{{!s.active ? s.n && s.n.active : s.n && s.n.before}}</view>
							</view>
							<view class="down">
								<view class="shadow"></view>
								<view class="inn">{{!s.active ? s.n && s.n.active : s.n && s.n.before}}</view>
...
<style lang="scss">
	...
	@font-face {
		...
		/* Project id 3193034 */
		src: url('//at.alicdn.com/t/font_3193034_1hsyij25xur.woff2?t=1645278828762') format('woff2'),
			url('//at.alicdn.com/t/font_3193034_1hsyij25xur.woff?t=1645278828762') format('woff'),
			url('//at.alicdn.com/t/font_3193034_1hsyij25xur.ttf?t=1645278828762') format('truetype');
	}
